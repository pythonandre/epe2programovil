...
import com.Espartans.BazarDeKarla.Fragments.GestionUserFragment;
import com.Espartans.BazarDeKarla.Fragments.MiCuentaFragment;
import com.Espartans.BazarDeKarla.Fragments.NotificacionAdminFragment;
...
public class MenuAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.GestionUser){
            fragmentManager = getSupportFragmentManager();
            fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container, new GestionUserFragment());
            fragmentTransaction.commit();
        ...
        if (item.getItemId() == R.id.Notificacion){
            fragmentManager = getSupportFragmentManager();
            fragmentTransaction = fragmentManager.beginTransaction();
            fragmentTransaction.replace(R.id.container, new NotificacionAdminFragment());
            fragmentTransaction.commit();
